from sqlalchemy import create_engine, MetaData, Table, Column, String, DECIMAL, Date, UniqueConstraint
...
def create_table(engine):
    ...
    tabla = Table(
        ...
        Column('SubCategoria', String(255)),
        ...
        Column('Fecha', Date),
        UniqueConstraint('DescripcionCorta', name='uix_1')
    )
...
def insert_data(engine,tabla, datos):
    with engine.begin() as connection:
        ...
        on_duplicate_key = insert_values.on_duplicate_key_update(
            ...
            SubCategoria=insert_values.inserted.SubCategoria,
...
def main():
    ...
    datos=read_csv('productos_7-eleven2023-11-30.csv')    

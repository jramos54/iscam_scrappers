...
def sucursales_dulces(driver,fecha):
    """
    Funcion para el informante El rey del Dulce
    """
    INFORMANTE='El rey del Dulce'
    URL='https://www.elreydeldulce.com/en/ubicaciones'
    directorio=[]
    ...
    main=soup.find(id="wrap")
    

    sucursales=main.find_all('div',class_="card bg-white h-100")
    ...
    for sucursal in sucursales:
        ...
        text_title=sucursal.find('h3',class_="card-title").text.strip()
        text_sucursal=sucursal.find('p',class_="card-text").text.strip()
        
        
        tienda['Sucursal']=text_title

        
        tienda['Direccion']=text_sucursal
...
if __name__=='__main__':
    ...
    filename='reydulce_tiendas_'+stamped_today+'.csv'

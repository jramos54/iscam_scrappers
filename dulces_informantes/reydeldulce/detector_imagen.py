...
def verificar_colores(imagen_path, valor_1, valor_2, valor_3):
    ...
    for color, porcentaje in resultados.items():
        ...
        if color == (0, 0, 0) and porcentaje >= valor_1:
            return False
        elif color == (204, 204, 204) and porcentaje >= valor_2:
            return False
        elif color == (203, 203, 203) and porcentaje >= valor_3:
            return False
...
if __name__=='__main__':
    imagen_path = ['sin_imagen.png','imagen_negro_cafe.png']  # Reemplaza con la ruta de tu imagen
    ...
    #     resultado = verificar_colores(imagen, 66, 31, 1)
    #     print(resultado)
...
# Abre el archivo CSV de entrada y crea uno nuevo para escribir los resultados
    with open(archivo_entrada, 'r') as entrada, open(archivo_salida, 'w', newline='') as salida:
        ...
        for fila in lector_csv:
            link = fila['Img']
            imagen_base64=base_image(link)
            if verificar_colores_base64(imagen_base64, 66, 31, 1):
